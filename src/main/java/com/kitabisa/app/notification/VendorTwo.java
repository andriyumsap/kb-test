...
@Component
public class VendorTwo extends Vendor {
    @Value("${sms.url.vendor-two}")
    private String URL_VENDOR_TWO;
    ...
    public boolean send(String phoneNumber, String message) {
        try {
            ...
            final String baseUrl = URL_VENDOR_TWO.replace("{nmbr}",phoneNumber).replace("{ctn}", message);
